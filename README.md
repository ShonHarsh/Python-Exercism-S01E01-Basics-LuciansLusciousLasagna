![Banner](Data/Images/Python-Exercism-S01E01-Basics-LuciansLusciousLasagna-Banner.png)

### Python-Exercism-S01E01-Basics-LuciansLusciousLasagna
...
### Submission Command
`exercism submit "Exercism\python\guidos-gorgeous-lasagna\lasagna.py"`

## Testing Command
`pytest -o markers=task`

![Banner](Data/Images/Python-Exercism-S01-Basics-Title.png)
